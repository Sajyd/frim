    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-dark-900 border border-dark-800 rounded-2xl p-8">
          <h1 className="font-display text-2xl font-semibold text-center mb-2">Create account</h1>
          <p className="text-dark-500 text-center mb-8">Start creating animations today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-dark-600 mt-1">Minimum 6 characters</p>
            </div>
          ...
          <p className="text-center text-dark-500 text-sm mt-6">
            ...
            <Link href="/auth/signin" className="text-frim-400 hover:text-frim-300">
              Sign in
            </Link>
          </p>
        </div>
